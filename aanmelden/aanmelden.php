...
add_shortcode('vwAanmelden', 'fVWAanmelden');
 function fVWAanmelden() {
    ...
    $html .= '<div>';
    $html .= '<div class="entry">';
    $html .= '<label class="red" for="aanEmail">E-mailadres vrijwilliger:</label><input type="text" name="email" id="vwEmail" placeholder="Email" class="required formatEmail"><button id="vwSubmit" type="submit" disabled="disabled" opacity="1" style="opacity: 0.5">Aanmelden</button></div>';
